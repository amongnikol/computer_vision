...
class BboxDetector():
    ...
    def __init__(self, model_name="frcnn-mobilenet",
        ...
        # Mapping model name to weight enum
        weights_map = {
            "frcnn-resnet": FasterRCNN_ResNet50_FPN_Weights.DEFAULT,
            "frcnn-mobilenet": FasterRCNN_MobileNet_V3_Large_320_FPN_Weights.DEFAULT,
        ...
        self.model = models[self.model_name](weights=weights).to(self.device)
